        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <img 
                ...
                alt="Techviora - MVP Development Company Gurugram" 
                className="h-12 w-auto mb-4"
              />
              <p className="text-gray-400 leading-relaxed mb-4">
                Leading MVP development company in Gurugram, building scalable products for startups across India.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <li key={index}>
                    <a href="#pricing" className="text-gray-400 hover:text-lime-400 transition-colors text-sm">
                      {service}
                    </a>
                  </li>
                ))}
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-4">
                Based in Gurugram, serving startups globally
              </p>
            </div>
          ...
          <div className="py-8 border-t border-lime-500/20">
            <p className="text-sm text-gray-500 leading-relaxed text-center max-w-4xl mx-auto mb-6">
              <span className="text-lime-400 font-semibold">Techviora</span> is a leading MVP development company based in Gurugram (Gurgaon), specializing in rapid product development for startups. We offer end-to-end mobile app development, AI-powered product building, and scalable backend solutions across Delhi NCR, Bangalore, Mumbai, and throughout India. Our AI-assisted development process reduces costs by 40% and delivers MVPs in 30-60 days.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-lime-500/20">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-500 text-sm text-center md:text-left">
                © {currentYear} Techviora. All rights reserved. MVP Development Company in Gurugram, India.
              </p>
