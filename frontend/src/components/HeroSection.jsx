      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-500/10 border border-lime-500/20 backdrop-blur-sm mb-8 animate-fade-in">
            ...
            <span className="text-sm text-lime-400 font-medium">Trusted by startups and growing businesses</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 animate-slide-up">
            <span className="text-white">Build Your </span>
            <span className="text-lime-400 bg-clip-text">Product</span>
            <br />
            <span className="text-white">Not Just an App</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl sm:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-up delay-100">
            We help startups and growing businesses design, build, and scale complete digital products — including mobile apps, backend systems, admin panels, and infrastructure.
          </p>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto animate-fade-in delay-300">
            <div className="text-center group">
              ...
              <div className="text-sm text-gray-500 uppercase tracking-wider">Days to MVP</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl sm:text-4xl font-bold text-lime-400 mb-2 group-hover:scale-110 transition-transform">40-60%</div>
              <div className="text-sm text-gray-500 uppercase tracking-wider">Faster Launch</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl sm:text-4xl font-bold text-lime-400 mb-2 group-hover:scale-110 transition-transform">100%</div>
              <div className="text-sm text-gray-500 uppercase tracking-wider">Ownership</div>
            </div>
            <div className="text-center group">
              <div className="text-3xl sm:text-4xl font-bold text-lime-400 mb-2 group-hover:scale-110 transition-transform">∞</div>
              <div className="text-sm text-gray-500 uppercase tracking-wider">Scalability</div>
            </div>
          </div>
        </div>
      </div>
