      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-500/10 border border-lime-500/20 backdrop-blur-sm mb-8 animate-fade-in">
            ...
            <span className="text-sm text-lime-400 font-medium">Serving startups in Gurugram, Gurgaon, Delhi NCR & across India</span>
          </div>

          {/* Main Headline - SEO Optimized H1 */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 animate-slide-up">
            <span className="text-white">MVP Development Company in </span>
            <span className="text-lime-400">Gurugram</span>
            <br />
          ...
          <p className="text-xl sm:text-2xl text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-up delay-100">
            End-to-end product development for startups — including mobile apps, backend systems, admin panels, and AI-powered features. Based in Gurugram, trusted across India.
          </p>
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto animate-fade-in delay-300">
            ...
            <div className="text-center group">
              <div className="text-3xl sm:text-4xl font-bold text-lime-400 mb-2 group-hover:scale-110 transition-transform">₹1.5L+</div>
