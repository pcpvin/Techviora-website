...
export const WhatWeDo = () => {
  const services = [
    ...
    { icon: Server, title: 'Backend architecture & APIs', color: 'lime' },
    { icon: Settings, title: 'Admin panel & control systems', color: 'lime' },
    { icon: Rocket, title: 'Deployment, scaling & optimization', color: 'lime' }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
              We Take End-to-End <br />
              <span className="text-lime-400">Ownership</span> of Your Product
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Most teams focus only on building apps.<br />
              We focus on building <span className="text-lime-400 font-semibold">complete products</span> that actually work at scale.
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl sm:text-3xl font-bold text-white mb-2">
                      One team. Full ownership. Zero chaos.
                    </h3>
                    <p className="text-lg text-gray-400">
                      From idea to launch — and beyond — we handle everything so you can focus on your business.
                    </p>
                  </div>
                </div>
              </CardContent>
